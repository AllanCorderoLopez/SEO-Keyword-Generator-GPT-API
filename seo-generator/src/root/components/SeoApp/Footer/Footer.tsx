...
<footer className="bg-color-nav mt-24  w-full">
    <div className="mx-auto w-full  p-4 py-6 lg:py-8">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            ...
            height={130}
            alt="logo"
          />                  <span className="self-center text-2xl font-bold  whitespace-nowrap text-gray-100">SeoStudio</span>
              </a>
          </div>
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  ...
                  <ul className="text-gray-200 dark:text-gray-200 font-medium">
                      <li className="mb-4">
                          <a href="#" className="hover:underline">SeoStudio</a>
                      </li>
                      <li>
              ...
              <div>
                  ...
                  <ul className="text-gray-200 dark:text-gray-200 font-medium">
                      <li className="mb-4">
                          <a href="https://github.com/AllanCorderoLopez" className="hover:underline ">Github</a>
                      </li>
                      <li>
                          <a href="https://www.linkedin.com/in/allan-cordero-l%C3%B3pez/" className="hover:underline">LinkedIn</a>
                      </li>
                  </ul>
              </div>
          </div>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-200 sm:text-center dark:text-gray-400">© 2023 <a href="#" className="hover:underline">SEOGenius™</a>. All Rights Reserved.
          </span>
